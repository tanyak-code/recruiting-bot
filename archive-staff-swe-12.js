#!/usr/bin/env node
/**
 * Staff SWE — move score 1 and 2 → "To Be Archived & Dispo"
 * Only touches candidates currently in "Application Review".
 * Run: node archive-staff-swe-12.js
 */
...
const JOB_ID     = "203af220-b197-4a58-827f-072cb1ae0611";
...
async function main() {
  ...
  console.log(`\n📋 Staff SWE — Score 1/2 → To Be Archived & Dispo`);
