#!/usr/bin/env node
/**
 * Sr. PM (Jordan) — move score 1/2 → To Be Archived & Dispo
 *
...
const JOB_ID     = "46206300-60c0-40f4-9d0a-c485be88f0fa"; // Sr. PM (Jordan) — new req
...
async function main() {
  ...
  console.log(`\n📋 Sr. PM (Jordan) — score 1/2 → To Be Archived & Dispo`);
  ...
  if (!archiveId)   { console.error("\n❌ Could not find 'To Be Archived & Dispo' stage — make sure you have at least one candidate in that stage, or check stage names above."); process.exit(1); }
